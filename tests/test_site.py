...
def test_site_loads_config(site: Site) -> None:  # noqa
    assert site.config.title == "Test website"


def test_page_sorting(site: Site) -> None:  # noqa
    """
...
def test_post_sorting(site: Site) -> None:  # noqa
    """
...
def test_copyright(site: Site) -> None:  # noqa
    site.load()
    assert site.copyright == "Copyright 2010 - 2017, Jimbo Jawn"


def test_new_page(site: Site) -> None:  # noqa
    site.new_page()
...
def test_new_post(site: Site) -> None:  # noqa
